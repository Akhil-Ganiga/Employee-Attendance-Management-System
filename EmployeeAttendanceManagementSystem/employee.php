...
<form  action="insertemployee.php" method="POST">
 ...
 <div class="form-group">
   ...
   <input type="text" name="email" class="form-control" id="formGroupExampleInput2" placeholder="name@example.com" required="" >
 </div>
 <div class="form-group">
   <label for="formGroupExampleInput2">Date of Birth:</label>
   <input type="text" name="dateofbirth" class="form-control" id="formGroupExampleInput2" placeholder="xx-xx-xxxx required="required="" >
 </div>
 <div class="form-group">
   <label for="formGroupExampleInput2">Contact No:</label>
   <input type="text" name="contact" class="form-control" id="formGroupExampleInput2" placeholder="Contact Number" required="" >
 </div> 
 <div class="form-group">
   <label for="formGroupExampleInput2">Department:</label>
   <input type="text" name="department" class="form-control" id="formGroupExampleInput2" placeholder="CSE , IT..." required="" >
 </div> 
